<div>
    ...
    <div class="container container-lg">
        <div class="border border-gray-100 rounded-8 px-30 py-20 mb-40"> 
            <span class="">Have an Account ? <a href="account.html" class="fw-semibold text-gray-900 hover-text-decoration-underline hover-text-main-600">Click here to login</a> </span>
        </div>
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <form action="#" class="pe-xl-5">
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            <input type="text" class="common-input border-gray-100" placeholder="Country">
                        </div>
                        <div class="col-12">
                            <input type="text" class="common-input border-gray-100" placeholder="City | District">
                        </div>
                        <div class="col-12">
                            <input type="text" class="common-input border-gray-100" placeholder="Division">
                        </div>
                        <div class="col-12">
                            <input type="text" class="common-input border-gray-100" placeholder="House number and street name">
                        </div>
                        <div class="col-12">
                            <input type="text" class="common-input border-gray-100" placeholder="Apartment, suite, unit, Plot number etc. (Optional)">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-sm-12 mt-10">
                            {{--<button type="submit" class="btn btn-main py-18 px-32 rounded-8">Create Account</button>--}}
                            <a href="/login" type="submit" class="btn btn-main py-18 px-32 rounded-8">Create Account</a>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="checkout-sidebar">
                    ...
                    <div class="border border-gray-100 rounded-8 px-24 py-40 mt-24">
                        ...
                        <div class="flex-between gap-24 mb-32">
                            ...
                            <span class="text-gray-900 fw-bold text-md font-heading-two">UGX 250.00</span>
                        </div>
                        <div class="flex-between gap-24 mb-32">
                            <div class="flex-align gap-12">
                                <span class="text-gray-900 fw-normal text-md font-heading-two w-144">HP Chromebook With Intel Celeron</span>
                        ...
                        <div class="border-top border-gray-100 pt-30  mt-30">
                            <div class="mb-32 flex-between gap-8">
                                ...
                                <span class="text-gray-900 font-heading-two text-md fw-bold">UGX 859.00</span>
                            </div>
