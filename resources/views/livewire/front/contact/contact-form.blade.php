        ...
        <div class="row gy-5">
            <div class="col-lg-8">
                <div class="contact-box border border-gray-100 rounded-16 px-24 py-40">
                    <form action="#">
                        <h6 class="mb-32">Send Us Message For More Inquiries</h6>
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-12 mt-20">
                                <button type="submit" class="btn btn-main py-18 px-32 rounded-8">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-lg-4">
                <div class="contact-box border border-gray-100 rounded-16 px-24 py-40">
                    ...
                    <div class="flex-align gap-16 mb-16">
                        ...
                        <a href="tel:+00123456789" class="text-md text-gray-900 hover-text-main-600">+256 705 344 416 <br>+256 784 497 675</a>
                    </div>
                    <div class="flex-align gap-16 mb-16">
                        ...
                        <a href="mailto:support24@marketpro.com" class="text-md text-gray-900 hover-text-main-600">info@standardsupermarket.com</a>
                    </div>
                    <div class="flex-align gap-16 mb-0">
                        ...
                        <span class="text-md text-gray-900 ">
                            Aponye Building, Opp. Old Taxi Park,<br>
                            Yamaha Building Opp. Old Taxi park,<br>
                            Garden City, Yusuf Lule Road-Former Uchumi<br>
                            P.O Box 8334 Kampala-Uganda
                        </span>
                    </div>
                </div>
                <div class="mt-24 flex-align flex-wrap gap-16">
                    <a href="tel:+256 705 344 416" class="bg-neutral-600 hover-bg-main-600 rounded-8 p-10 px-16 flex-between flex-wrap gap-8 flex-grow-1">
