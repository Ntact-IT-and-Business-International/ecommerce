                            ...
                            <div class="product-details__thumb-slider border border-gray-100 rounded-16">
                                <div class="">
                                    <div class="product-details__thumb flex-center h-100">
                                        <img src="{{ asset('assets/images/product-details-thumb1.png')}}" alt="">
                                    </div>
                                </div>
                                <div class="">
                                    <div class="product-details__thumb flex-center h-100">
                                        <img src="{{ asset('assets/images/product-details-thumb2.png')}}" alt="">
                                    </div>
                                </div>
                                <div class="">
                                    <div class="product-details__thumb flex-center h-100">
                                        <img src="{{ asset('assets/images/product-details-thumb3.png')}}" alt="">
                                    </div>
                                </div>
                                <div class="">
                                    <div class="product-details__thumb flex-center h-100">
                                ...
                                <div class="product-details__images-slider">
                                    <div>
                                        <div class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                                            <img src="{{ asset('assets/images/product-details-img1.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div>
                                        <div class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                                            <img src="{{ asset('assets/images/product-details-img2.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div>
                                        <div class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                                            <img src="{{ asset('assets/images/product-details-img3.png')}}" alt="">
                                        </div>
                                    </div>
                                    <div>
                                        <div class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    ...
                                    <div class="d-flex align-items-start gap-24 pb-44 border-bottom border-gray-100 mb-44">
                                        <img src="{{ asset('assets/images/comment-img1.png')}}" alt="" class="w-52 h-52 object-fit-cover rounded-circle flex-shrink-0">
