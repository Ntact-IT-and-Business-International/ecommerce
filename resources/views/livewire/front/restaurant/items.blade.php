                ...
                <div class="col-lg-3">
                    <div class="shop-sidebar">
                        ...
                        <div class="shop-sidebar__box rounded-8">
                            <img src="{{ asset('assets/images/advertise-img1.png')}}" alt="">
                        </div>
                    </div>
                </div>
                <!-- Sidebar End -->
                ...
                <div class="col-lg-9">
                    ...
                    <div class="list-grid-wrapper">
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img1.png')}}" alt="" class="w-auto max-w-unset">
                            ...
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                                </h6>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img2.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img3.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            ...
                            <img src="{{ asset('assets/images/product-two-img4.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img5.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img6.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img7.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img8.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <span class="product-card__badge bg-danger-600 px-8 py-4 text-sm text-white position-absolute inset-inline-start-0 inset-block-start-0">Sale 50% </span>
                            <img src="{{ asset('assets/images/product-two-img9.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img10.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img11.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            ...
                            <img src="{{ asset('assets/images/product-two-img12.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img13.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <img src="{{ asset('assets/images/product-two-img14.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
                        ...
                        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            <a href="/restaurant/item-details" class="product-card__thumb flex-center rounded-8 bg-gray-50 position-relative">
                            <span class="product-card__badge bg-primary-600 px-8 py-4 text-sm text-white position-absolute inset-inline-start-0 inset-block-start-0">Best Sale  </span>
                            <img src="{{ asset('assets/images/product-two-img15.png')}}" alt="" class="w-auto max-w-unset">
                            </a>
                            <div class="product-card__content mt-16">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="/restaurant/item-details" class="link text-line-2" tabindex="0">Taylor Farms Broccoli Florets Vegetables</a>
