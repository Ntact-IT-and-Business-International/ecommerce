        ...
        <nav class="header-inner flex-between">
            ...
            <form action="#" class="flex-align flex-wrap form-location-wrapper">
                <div class="search-category d-flex h-48 select-border-end-0 radius-end-0 search-form d-sm-flex d-none">
                    <select class="js-example-basic-single border border-gray-200 border-end-0" name="state">
                        ...
                        <option value="1">New & Trending</option>
                        <option value="1">Home, Garden & Tools</option>
                        <option value="1">Electronics & Video Games</option>
                        <option value="1">Clothing,Shoes & Accessories</option>
                        <option value="1">Baby,Toys & Kids</option>
                        <option value="1">Beauty & Personal Care</option>
                        <option value="1">Health & Welliness</option>
                        <option value="1">Household Essentials</option>
                        <option value="1">Sports & Outdoors</option>
                        <option value="1">School,Office & Art Supplies</option>
                        <option value="1">Seasonal Decor & Party Supplies</option>
                        <option value="1">Movies,Music & Books</option>
                    ...
                    <div class="line-height-1">
                        ...
                        <div class="line-height-1">
                            <select class="js-example-basic-single border border-gray-200 border-end-0" name="state">
                                ...
                                <option value="1">Mukono</option>
                                <option value="1">Wakiso</option>
                                <option value="1">Mityana</option>
                                <option value="1">Kabale</option>
                                <option value="1">Mbarara</option>
                                <option value="1">Hoima</option>
                                <option value="1">Gulu</option>
                                <option value="1">Arua</option>
                                <option value="1">Mbale</option>
                                <option value="1">Entebbe</option>
                                <option value="1">Soroti</option>
            ...
            <div class="header-right flex-align d-lg-block d-none">
                <div class="flex-align flex-wrap gap-12">
                    ...
                    <a href="/shopping-cart" class="flex-align gap-4 item-hover">
