            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                    ...
                    <div class="">
                        ...
                        <span class="text-sm text-heading">Free shipping all over Uganda</span>
                    </div>
                </div>
            </div>
            <div class="col-xxl-3 col-sm-6">
                <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                    ...
                    <div class="">
                        ...
                        <span class="text-sm text-heading">We exceed customer's expectation</span>
                    </div>
                </div>
            </div>
            <div class="col-xxl-3 col-sm-6">
                <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                    ...
                    <div class="">
                        ...
                        <span class="text-sm text-heading">Trusted and Secure Payment Methods</span>
                    </div>
                </div>
            </div>
            <div class="col-xxl-3 col-sm-6">
                <div class="shipping-item flex-align gap-16 rounded-16 bg-main-50 hover-bg-main-100 transition-2">
                    ...
                    <div class="">
                        ...
                        <span class="text-sm text-heading">Real Time Customer Support</span>
                    </div>
                </div>
            </div>
        </div>
